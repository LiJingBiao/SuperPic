...
- (void)viewDidLoad {
    ...
    btn.frame = CGRectMake(0, 0, 53, 30);
...
-(QRView *)qrView {
    ...
    if (!_qrView) {
        ...
        //screenRect.size = CGSizeMake(screenRect.size.width, screenRect.size.height-64);
        //CGRect screenRect = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height-64);
